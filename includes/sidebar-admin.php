...
<div class="flex min-h-screen bg-white dark:bg-vercel-gray-900 font-sans text-vercel-black dark:text-vercel-white transition-colors duration-200"
    x-data="{ sidebarOpen: window.innerWidth > 1024, userMenuOpen: false, notifOpen: false, isDark: document.documentElement.classList.contains('dark') }"
    @resize.window="sidebarOpen = window.innerWidth > 1024"
    @theme-changed.window="isDark = $event.detail.theme === 'dark'">

    <!-- Sidebar -->
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-vercel-gray-900 border-r border-vercel-gray-200 dark:border-vercel-gray-800 transition-transform duration-200 transform"
        ...
        <div class="flex flex-col h-full">
            ...
            <!-- Sidebar Footer -->
            <div class="p-4 border-t border-vercel-gray-200 dark:border-vercel-gray-800">
                <button onclick="adminLogout()" class="flex items-center gap-2.5 w-full px-3 py-2 text-sm text-vercel-gray-500 hover:text-vercel-red hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 rounded-md transition-colors">
    ...
    <!-- Content Wrapper -->
    <div class="flex-1 flex flex-col min-w-0 transition-all duration-200 bg-vercel-gray-100 dark:bg-vercel-gray-900"
        :class="sidebarOpen ? 'lg:ml-64' : 'ml-0'">

        <!-- Top Header -->
        <header class="h-14 bg-white dark:bg-vercel-gray-900 border-b border-vercel-gray-200 dark:border-vercel-gray-800 sticky top-0 z-40 px-6 flex items-center justify-between transition-colors duration-200">
            <!-- Left Side -->
            <div class="flex items-center gap-4">
                <button @click="sidebarOpen = !sidebarOpen" class="w-8 h-8 flex items-center justify-center rounded-md hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 text-vercel-gray-500 transition-colors">
                    <i data-lucide="menu" class="w-4 h-4"></i>
                </button>
                <div class="text-xs font-medium text-vercel-gray-400 flex items-center gap-2">
                    <span>Admin</span>
                    <i data-lucide="chevron-right" class="w-3 h-3"></i>
                    <span class="text-vercel-black dark:text-vercel-white font-semibold"><?php echo str_replace('.php', '', ucfirst($currentPage)); ?></span>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                <!-- Theme Toggle -->
                <button onclick="toggleTheme()" class="w-8 h-8 flex items-center justify-center rounded-md hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 text-vercel-gray-500 transition-colors">
                    <i x-show="!isDark" data-lucide="moon" class="w-4 h-4"></i>
                    <i x-show="isDark" x-cloak data-lucide="sun" class="w-4 h-4 text-vercel-amber"></i>
                </button>

                <div class="h-4 w-px bg-vercel-gray-200 dark:bg-vercel-gray-800"></div>

                <!-- Language Toggle -->
                <div class="flex items-center bg-vercel-gray-100 dark:bg-vercel-gray-800 rounded-md p-0.5">
                    <a href="?lang=th" class="px-2.5 py-1 text-[10px] font-bold rounded transition-all <?php echo $currentLang === 'th' ? 'bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black shadow-sm' : 'text-vercel-gray-500 hover:text-vercel-black dark:hover:text-vercel-white'; ?>">TH</a>
                    <a href="?lang=en" class="px-2.5 py-1 text-[10px] font-bold rounded transition-all <?php echo $currentLang === 'en' ? 'bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black shadow-sm' : 'text-vercel-gray-500 hover:text-vercel-black dark:hover:text-vercel-white'; ?>">EN</a>
                </div>
                ...
                <div class="relative" @click.away="notifOpen = false">
                    <button @click="notifOpen = !notifOpen"
                        class="w-8 h-8 flex items-center justify-center rounded-md hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 text-vercel-gray-500 transition-colors relative">
                        <i data-lucide="bell" class="w-4 h-4"></i>
                    ...
                    <div x-show="notifOpen"
                        ...
                        class="absolute right-0 mt-2 w-80 bg-white dark:bg-vercel-gray-900 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg shadow-xl z-50 overflow-hidden">
                        <div class="p-4 border-b border-vercel-gray-100 dark:border-vercel-gray-800 flex items-center justify-between bg-vercel-gray-100/50 dark:bg-vercel-gray-800/50">
                ...
                <div class="relative" @click.away="userMenuOpen = false">
                    ...
                    <div x-show="userMenuOpen"
                        ...
                        x-transition:enter-start="opacity-0 scale-95"
                        x-transition:enter-end="opacity-100 scale-100"
                        class="absolute right-0 mt-2 w-48 bg-white dark:bg-vercel-gray-900 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg shadow-xl z-50 p-1">
                        <a href="<?php echo SITE_URL; ?>/admin/profile.php" class="flex items-center gap-2 px-3 py-2 rounded-md text-xs text-vercel-gray-600 dark:text-vercel-gray-400 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 hover:text-vercel-black dark:hover:text-vercel-white transition-colors">
                            <i data-lucide="user" class="w-3.5 h-3.5"></i>
                            <span><?php echo __('admin_nav_profile'); ?></span>
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/settings.php" class="flex items-center gap-2 px-3 py-2 rounded-md text-xs text-vercel-gray-600 dark:text-vercel-gray-400 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 hover:text-vercel-black dark:hover:text-vercel-white transition-colors">
                            <i data-lucide="settings" class="w-3.5 h-3.5"></i>
                            <span><?php echo __('admin_nav_settings'); ?></span>
                        </a>
                        <div class="my-1 border-t border-vercel-gray-100 dark:border-vercel-gray-800"></div>
                        <button onclick="adminLogout()" class="flex items-center gap-2 w-full px-3 py-2 rounded-md text-xs text-vercel-red hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 transition-colors">
