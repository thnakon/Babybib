        ...
        <!-- Admin Footer -->
        <footer class="mt-auto px-6 py-10 border-t border-vercel-gray-200 dark:border-vercel-gray-800 bg-white dark:bg-vercel-gray-900">
            <div class="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex flex-col sm:flex-row items-center gap-4 text-vercel-gray-400 text-[13px]">
                    <p>&copy; <?php echo date('Y'); ?> <span class="text-vercel-black dark:text-vercel-white font-semibold tracking-tight">Babybib Admin</span>. <?php echo __('admin_footer_rights'); ?></p>
                </div>

                <div class="flex items-center gap-8">
                    <a href="<?php echo SITE_URL; ?>" target="_blank" class="flex items-center gap-2 text-vercel-gray-400 hover:text-vercel-black dark:hover:text-vercel-white transition-colors text-[13px] font-medium">
