...
<main class="start-page slide-up">
    ...
    <div class="start-header">
        ...
        <p><?php echo $currentLang === 'th' ? 'เรียนรู้การสร้างบรรณานุกรมตามรูปแบบ APA 7<sup>th</sup> Edition ได้ง่ายๆ ใน 4 ขั้นตอน' : 'Learn to create APA 7<sup>th</sup> bibliographies easily in 4 steps'; ?></p>
    </div>
    ...
    <div class="cta-section slide-up">
        ...
        <p><?php echo $currentLang === 'th' ? 'สร้างบรรณานุกรมตามรูปแบบ APA 7<sup>th</sup> Edition ได้ทันที ไม่ต้องสมัครสมาชิกก็ใช้งานได้เลย!' : 'Create APA 7<sup>th</sup> bibliographies instantly. No registration required to get started!'; ?></p>
