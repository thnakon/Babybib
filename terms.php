...
<main class="legal-container">
    ...
    <div class="legal-content">
        ...
        <?php if ($currentLang === 'th'): ?>
            <p>ยินดีต้อนรับสู่ Babybib กรุณาอ่านข้อกำหนดและเงื่อนไขเหล่านี้อย่างละเอียดก่อนใช้งานเว็บไซต์ การเข้าใช้งานเว็บไซต์นี้ถือว่ามีการยอมรับข้อกำหนดเหล่านี้ทั้งหมด</p>
            ...
            <p>ผู้ใช้งานตกลงที่จะใช้งานบริการตามวัตถุประสงค์ที่ระบุไว้เท่านั้น และไม่กระทำการใดๆ ดังต่อไปนี้:</p>
            <ul>
                ...
                <li>ละเมิดสิทธิ์ในทรัพย์สินทางปัญญาของระบบหรือของผู้อื่น</li>
            </ul>

            <h2>3. บัญชีผู้ใช้งานและความปลอดภัย</h2>
            <p>ในการสร้างบัญชีผู้ใช้งาน มีหน้าที่รับผิดชอบข้อมูลดังนี้:</p>
            <ul>
                <li>ต้องให้ข้อมูลที่เป็นความจริงในการสมัครสมาชิก</li>
                <li>ต้องรักษาความลับของรหัสผ่านและข้อมูลบัญชี</li>
                <li>ผู้ใช้งานต้องรับผิดชอบต่อกิจกรรมทั้งหมดที่เกิดขึ้นภายใต้บัญชี</li>
                <li>หากพบการใช้งานที่ไม่ได้รับอนุญาต ต้องแจ้งให้ระบบทราบทันที</li>
            </ul>

            <h2>4. ข้อจำกัดความรับผิดชอบ</h2>
            <div class="important-notice">
                มีการพยายามอย่างเต็มที่เพื่อให้ข้อมูลและการสร้างบรรณานุกรมมีความถูกต้องแม่นยำสูงสุด อย่างไรก็ตาม ผู้ใช้มีหน้าที่ตรวจสอบความถูกต้องขั้นสุดท้าย (Final Verification) ตามมาตรฐานคู่มือการเขียนบรรณานุกรมที่เกี่ยวข้องเสมอ
            </div>
            <p>ระบบไม่รับประกันว่าบริการจะทำงานได้โดยไม่มีข้อผิดพลาดหรือไม่มีการขัดข้อง และจะไม่รับผิดชอบต่อความสูญเสียหรือความเสียหายใดๆ ที่เกิดจากการใช้งาน หรือการไม่สามารถใช้งานบริการได้</p>

            <h2>5. ทรัพย์สินทางปัญญ</h2>
            <p>เนื้อหา โลโก้ ซอร์สโค้ด และการออกแบบทั้งหมดบนเว็บไซต์ Babybib เป็นทรัพย์สินทางปัญญาของระบบ ห้ามมิให้ทำซ้ำ ดัดแปลง หรือนำไปใช้เพื่อการค้าโดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษร</p>

            <h2>6. การยกเลิกและปิดกั้นการเข้าถึง</h2>
            <p>ระบบขอสงวนสิทธิ์ในการยกเลิกบัญชีหรือระงับการเข้าถึงบริการชั่วคราวหรือถาวร โดยไม่ต้องแจ้งให้ทราบล่วงหน้า หากพบว่ามีการละเมิดข้อกำหนดการใช้งานเหล่านี้</p>

            <h2>7. การเปลี่ยนแปลงข้อกำหนด</h2>
            <p>ข้อกำหนดเหล่านี้อาจมีการเปลี่ยนแปลงเมื่อใดก็ได้ การเปลี่ยนแปลงจะมีผลทันทีเมื่อมีการประกาศบนเว็บไซต์ การใช้งานบริการต่อไปถือว่ามีการยอมรับข้อกำหนดที่เปลี่ยนแปลงนั้น</p>

            <h2>8. การติดต่อเรา</h2>
            <p>หากมีคำถามหรือข้อสงสัยเกี่ยวกับข้อกำหนดเหล่านี้ โปรดติดต่อระบบผ่านทางอีเมลที่ระบุไว้ในส่วนท้ายของเว็บไซต์</p>
        <?php else: ?>
