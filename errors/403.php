...
/**
 * Babybib - 403 Forbidden Error Page
 */
...
<head>
    ...
    <title>403 - <?php echo $pageTitle; ?> | Babybib</title>
    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #1e1e2d 0%, #1a2e3b 50%, #1e1e2d 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="error-container">
        ...
        <h1 class="error-title">ไม่มีสิทธิ์เข้าถึงหน้านี้</h1>
