...
$templateDefsLocalized = [
    ...
    'research' => [
        ...
        'sections' => [
            ...
            ['id' => 'ch3', 'type' => 'chapter', 'label' => $tr('บทที่ 3 วิธีดำเนินการวิจัย', 'Chapter 3 Methodology'), 'icon' => 'fa-book-open', 'number' => 3, 'title' => $tr('วิธีดำเนินการวิจัย', 'Research methodology'), 'subsections' => [
                'ระเบียบวิธีการวิจัย',
                'ขั้นตอนการดำเนินงาน',
...
function renderChapterPreview(section) {
    ...
    const chapterIntro = isResearch && (section.number === 2 || section.number === 3)
        ? `<p style="text-indent: 1.27cm;">${ section.number === 2 ? 'การศึกษาเอกสารและงานวิจัยที่เกี่ยวข้องกับการพัฒนาบริการแนะนำแหล่งสารสนเทศเฉพาะสาขาของห้องสมุดดาราศาสตร์ สถาบันวิจัยดาราศาสตร์แห่งชาติ (องค์การมหาชน) ผู้ศึกษาแบ่งการศึกษาออกเป็นดังนี้' : researchSampleCh3['intro'] }</p>`
        : '';
