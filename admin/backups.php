...
<div class="space-y-10 animate-in fade-in duration-500">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-vercel-gray-200 dark:border-vercel-gray-800 pb-8">
        <div>
            <h1 class="text-3xl font-black text-vercel-black dark:text-vercel-white tracking-tight"><?php echo __('admin_backup_mgmt'); ?></h1>
            <p class="text-vercel-gray-500 text-sm mt-2 font-medium">
                <?php echo __('admin_backup_desc'); ?>
            </p>
        </div>
        <button onclick="createBackup()" class="px-6 py-2.5 bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black rounded-md font-bold text-sm hover:bg-vercel-gray-800 dark:hover:bg-vercel-gray-100 transition-all flex items-center gap-2 shadow-sm">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg p-8 bg-white dark:bg-vercel-gray-900 shadow-sm group hover:border-vercel-black dark:hover:border-vercel-white transition-colors">
            <div class="flex items-center gap-4">
                <div class="w-10 h-10 rounded border border-vercel-gray-200 dark:border-vercel-gray-800 bg-vercel-gray-50 dark:bg-vercel-gray-800 flex items-center justify-center text-vercel-gray-400 group-hover:bg-vercel-black dark:group-hover:bg-vercel-white group-hover:text-white dark:group-hover:text-vercel-black group-hover:border-vercel-black dark:group-hover:border-vercel-white transition-all">
                    <i data-lucide="database" class="w-5 h-5"></i>
                </div>
                <div>
                    <span class="text-3xl font-black text-vercel-black dark:text-vercel-white block tracking-tighter"><?php echo count(array_filter($backups, fn($b) => $b['type'] === 'database')); ?></span>
        ...
        <div class="border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg p-8 bg-white dark:bg-vercel-gray-900 shadow-sm group hover:border-vercel-black dark:hover:border-vercel-white transition-colors">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <span class="text-3xl font-black text-vercel-black dark:text-vercel-white block tracking-tighter"><?php echo count(array_filter($backups, fn($b) => $b['type'] === 'files')); ?></span>
        ...
        <div class="border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg p-8 bg-white dark:bg-vercel-gray-900 shadow-sm group hover:border-vercel-black dark:hover:border-vercel-white transition-colors">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <span class="text-3xl font-black text-vercel-black dark:text-vercel-white block tracking-tighter"><?php echo formatSize(array_sum(array_column($backups, 'size'))); ?></span>
        ...
        <div class="overflow-x-auto">
            ...
            <?php else: ?>
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-vercel-gray-50/50 dark:bg-vercel-gray-800/50">
                    ...
                    <tbody class="divide-y divide-vercel-gray-100 dark:divide-vercel-gray-800">
                        <?php foreach ($backups as $backup): ?>
                            <tr class="hover:bg-vercel-gray-50/40 dark:hover:bg-vercel-gray-800/40 transition-colors group">
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        <div class="w-8 h-8 rounded border border-vercel-gray-200 dark:border-vercel-gray-800 flex items-center justify-center text-vercel-gray-400 group-hover:bg-vercel-black dark:group-hover:bg-vercel-white group-hover:text-white dark:group-hover:text-vercel-black group-hover:border-vercel-black dark:group-hover:border-vercel-white transition-all">
                                            <i data-lucide="<?php echo $backup['type'] === 'database' ? 'database' : 'folder'; ?>" class="w-4 h-4"></i>
                                        </div>
                                        <div>
                                            <div class="text-sm font-bold text-vercel-black dark:text-vercel-white tracking-tight underline-offset-4 decoration-vercel-gray-200 dark:decoration-vercel-gray-800 group-hover:underline"><?php echo htmlspecialchars($backup['name']); ?></div>
                                            <div class="text-[9px] font-black uppercase text-vercel-gray-400 tracking-widest"><?php echo $backup['type']; ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                    <span class="text-xs font-bold text-vercel-black dark:text-vercel-white leading-none bg-vercel-gray-100 dark:bg-vercel-gray-800 px-2 py-1 rounded"><?php echo formatSize($backup['size']); ?></span>
                                </td>
                                <td class="px-8 py-6">
                                    <div class="text-xs font-bold text-vercel-black dark:text-vercel-white"><?php echo date('d M Y', $backup['date']); ?></div>
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a href="<?php echo SITE_URL; ?>/api/admin/download-backup.php?file=<?php echo urlencode($backup['name']); ?>"
                                            class="p-2 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 rounded-md text-vercel-gray-400 hover:text-vercel-black dark:hover:text-vercel-white transition-colors" title="Download Snapshot">
                                            <i data-lucide="download" class="w-4 h-4"></i>
                                        </a>
                                        <button onclick="deleteBackup('<?php echo htmlspecialchars($backup['name']); ?>')"
                                            class="p-2 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 rounded-md text-vercel-gray-400 hover:text-vercel-red transition-colors" title="Purge Archive">
    ...
    <!-- CLI Instructions -->
    <div class="border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg bg-white dark:bg-vercel-gray-900 shadow-sm overflow-hidden p-8">
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-8 border-b border-vercel-gray-100 dark:border-vercel-gray-800 pb-6">
                <h3 class="text-sm font-black text-vercel-black dark:text-vercel-white uppercase tracking-widest flex items-center gap-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="space-y-8">
                    <div>
                        ...
                        <div class="bg-vercel-gray-50 dark:bg-vercel-gray-800 p-4 rounded-md border border-vercel-gray-100 dark:border-vercel-gray-700 font-mono text-sm text-vercel-gray-800 dark:text-vercel-gray-300 flex items-center justify-between group">
                    ...
                    <div>
                        ...
                        <div class="bg-vercel-gray-50 dark:bg-vercel-gray-800 p-4 rounded-md border border-vercel-gray-100 dark:border-vercel-gray-700 font-mono text-sm text-vercel-gray-800 dark:text-vercel-gray-300">
                ...
                <div class="space-y-8">
                    ...
                    <div class="p-5 border border-vercel-blue-500/20 dark:border-vercel-blue-500/10 bg-vercel-blue-500/5 rounded-md">
                        <p class="text-[11px] text-vercel-gray-400 font-bold italic tracking-tight uppercase">
...
<script>
    ...
    async function createBackup() {
        Modal.create({
            ...
            content: '<p class="text-vercel-gray-600 dark:text-vercel-gray-400 text-sm py-4 font-medium"><?php echo __('admin_snapshot_desc'); ?></p>',
            ...
            onOpen: (m) => {
                m.querySelector('#exec-backup').onclick = async (e) => {
                    ...
                    try {
                        ...
                        if (res.success) {
                            Toast.success('<?php echo __('admin_snapshot_done'); ?>');
    ...
    async function deleteBackup(filename) {
        Modal.create({
            ...
            content: '<div class="py-4 space-y-4"><p class="text-vercel-red text-sm font-bold border border-vercel-red/20 p-4 bg-vercel-red/5 rounded"><?php echo __('admin_purge_warn'); ?></p><div class="bg-vercel-gray-50 dark:bg-vercel-gray-800 p-4 border border-vercel-gray-100 dark:border-vercel-gray-700 rounded font-mono text-xs text-vercel-gray-500 dark:text-vercel-gray-400 break-all">' + filename + '</div></div>',
            footer: `<div class="flex items-center gap-2 w-full">
                <button class="${MODAL_CLASSES.btnSecondary} flex-1" onclick="Modal.close(this)"><?php echo __('cancel'); ?></button>
            ...
            onOpen: (m) => {
                m.querySelector('#exec-del').onclick = async (e) => {
                    ...
                    setLoading(btn, true);
                    try {
                        const res = await API.post('<?php echo SITE_URL; ?>/api/admin/delete-backup.php', {
                            filename
                        });
                        if (res.success) {
                            Toast.success('<?php echo __('admin_purge_done'); ?>');
