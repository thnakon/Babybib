...
<div class="space-y-10 animate-in fade-in duration-500">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-vercel-gray-200 dark:border-vercel-gray-800 pb-8">
        <div>
            <h1 class="text-3xl font-black text-vercel-black dark:text-vercel-white tracking-tight"><?php echo __('user_management'); ?></h1>
            <p class="text-vercel-gray-500 text-sm mt-2 font-medium">
                <?php echo __('admin_manage_users_desc'); ?>
                <span class="ml-2 px-2 py-0.5 border border-vercel-gray-200 dark:border-vercel-gray-800 text-vercel-black dark:text-vercel-white rounded text-[10px] font-bold"><?php echo number_format($total); ?> <?php echo __('admin_users_label'); ?></span>
            </p>
        </div>
        <button onclick="showAddUserModal()" class="flex items-center gap-2 bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black px-5 py-2 rounded-md font-bold text-sm hover:bg-vercel-gray-800 dark:hover:bg-vercel-gray-200 transition-all">
    ...
    <div class="flex flex-wrap items-center gap-4">
        <div class="flex-1 min-w-[300px] relative">
            ...
            <input type="text" id="user-search" value="<?php echo htmlspecialchars($search); ?>"
                ...
                class="w-full pl-10 pr-4 py-2 bg-white dark:bg-vercel-gray-900 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-md text-sm outline-none focus:border-vercel-black dark:focus:border-vercel-white transition-all">
        </div>

        <div class="flex flex-wrap items-center gap-2">
            <select id="filter-role" class="px-3 py-2 bg-white dark:bg-vercel-gray-900 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-md text-xs font-semibold text-vercel-gray-500 hover:border-vercel-black dark:hover:border-vercel-white transition-all outline-none">
            ...
            <select id="filter-lis" class="px-3 py-2 bg-white dark:bg-vercel-gray-900 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-md text-xs font-semibold text-vercel-gray-500 hover:border-vercel-black dark:hover:border-vercel-white transition-all outline-none">
            ...
            <select id="sort-order" class="px-3 py-2 bg-white dark:bg-vercel-gray-900 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-md text-xs font-semibold text-vercel-gray-500 hover:border-vercel-black dark:hover:border-vercel-white transition-all outline-none">
    ...
    <div class="border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg bg-white dark:bg-vercel-gray-900 overflow-hidden shadow-sm">
        <table class="w-full text-left text-sm">
            <thead class="bg-vercel-gray-100 dark:bg-vercel-gray-800 border-b border-vercel-gray-200 dark:border-vercel-gray-800 text-vercel-gray-500 dark:text-vercel-gray-400 font-medium tracking-tight">
                <tr>
            ...
            <tbody class="divide-y divide-vercel-gray-200 dark:divide-vercel-gray-800">
                <?php if (empty($users)): ?>
                    <tr>
                        <td colspan="4" class="px-6 py-20 text-center text-vercel-gray-400 font-medium"><?php echo __('admin_no_match'); ?></td>
                    </tr>
                <?php else: ?>
                        ...
                        <tr class="group hover:bg-vercel-gray-100/50 dark:hover:bg-vercel-gray-800/50 transition-colors">
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div class="font-bold text-vercel-black dark:text-vercel-white truncate"><?php echo htmlspecialchars(($u['name'] ?? '') . ' ' . ($u['surname'] ?? '')); ?></div>
                            ...
                            <td class="px-6 py-5">
                                <span class="text-[11px] font-bold text-vercel-gray-600 dark:text-vercel-gray-400 uppercase">
                                    <?php echo $u['role']; ?>
                                    <?php if ($u['is_lis_cmu']): ?>
                                        <span class="ml-1 px-1.5 py-0.5 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded text-[9px] text-vercel-gray-400">LIS</span>
                                    <?php endif; ?>
                                </span>
                            </td>
                            <td class="px-6 py-5 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button onclick="editUser(<?php echo htmlspecialchars(json_encode($u)); ?>)" class="p-2 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 rounded-md text-vercel-gray-400 hover:text-vercel-black dark:hover:text-vercel-white transition-colors">
                                        <i data-lucide="edit-3" class="w-4 h-4"></i>
                                    </button>
                                    <button onclick="toggleStatus(<?php echo $u['id']; ?>, <?php echo $u['is_active'] ? 0 : 1; ?>)" class="p-2 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 rounded-md text-vercel-gray-400 hover:text-vercel-amber transition-colors">
                                        <i data-lucide="<?php echo $u['is_active'] ? 'user-x' : 'user-check'; ?>" class="w-4 h-4"></i>
                                    </button>
                                    <button onclick="confirmDelete(<?php echo $u['id']; ?>)" class="p-2 hover:bg-vercel-gray-100 dark:hover:bg-vercel-gray-800 rounded-md text-vercel-gray-400 hover:text-vercel-red transition-colors">
    ...
    <?php if ($totalPages > 1): ?>
        <div class="flex items-center justify-between border-t border-vercel-gray-200 dark:border-vercel-gray-800 pt-8 mt-4">
            <div class="text-xs text-vercel-gray-400 font-medium">
                <?php echo __('admin_showing'); ?> <span class="text-vercel-black dark:text-vercel-white font-bold"><?php echo $offset + 1; ?></span> <?php echo __('admin_to'); ?> <span class="text-vercel-black dark:text-vercel-white font-bold"><?php echo min($total, $offset + $perPage); ?></span> <?php echo __('admin_of'); ?> <span class="text-vercel-black dark:text-vercel-white font-bold"><?php echo $total; ?></span>
            </div>
...
<script>
    ...
    const MODAL_CLASSES = {
        ...
        btnPrimary: 'px-6 py-2 bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black rounded-md font-bold text-sm hover:bg-vercel-gray-800 dark:hover:bg-vercel-gray-100 transition-all',
            ...
            content: `
                <form id="add-user-form" class="space-y-6 pt-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2 p-5 border border-vercel-gray-200 dark:border-vercel-gray-800 rounded-lg flex items-center justify-between gap-6">
                             <div>
                                <span class="text-sm font-bold text-vercel-black dark:text-vercel-white">LIS CMU Student</span>
                             ...
                             <div class="flex items-center gap-4">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <div class="w-11 h-6 bg-vercel-gray-200 dark:bg-vercel-gray-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-vercel-gray-200 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-vercel-black dark:peer-checked:bg-vercel-white"></div>
                                </label>
                             </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6 pt-2 overflow-x-hidden">
                     ...
                     <div class="flex flex-col md:flex-row items-center md:items-start gap-6 pb-6 border-b border-vercel-gray-200 dark:border-vercel-gray-800">
                        ...
                        <div class="flex-1 min-w-0 text-center md:text-left pt-1">
                            ...
                            <div class="flex flex-wrap items-center justify-center md:justify-start gap-1.5 mt-2">
                                <span class="px-1.5 py-0.5 border border-vercel-black dark:border-vercel-white bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black rounded text-[8px] font-black uppercase tracking-widest">@${user.username}</span>
                                <span class="px-1.5 py-0.5 border border-vercel-gray-200 dark:border-vercel-gray-800 bg-vercel-gray-50 dark:bg-vercel-gray-800 text-vercel-gray-400 rounded text-[8px] font-black uppercase tracking-widest">ID: #${user.id}</span>
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center gap-2.5 text-xs text-vercel-black dark:text-vercel-white font-bold">
                                    <div class="w-7 h-7 rounded border border-vercel-gray-100 dark:border-vercel-gray-800 bg-vercel-gray-50 dark:bg-vercel-gray-800 flex items-center justify-center text-vercel-gray-400"><i data-lucide="mail" class="w-3.5 h-3.5"></i></div>
                                    <span class="truncate">${user.email}</span>
                                </div>
                                <div class="flex items-center gap-2.5 text-xs text-vercel-black dark:text-vercel-white font-bold">
                                    <div class="w-7 h-7 rounded border border-vercel-gray-100 dark:border-vercel-gray-800 bg-vercel-gray-50 dark:bg-vercel-gray-800 flex items-center justify-center text-vercel-gray-400"><i data-lucide="building" class="w-3.5 h-3.5"></i></div>
                                ...
                                <div class="flex items-center gap-2.5 text-xs text-vercel-emerald font-black">
                                    <div class="w-7 h-7 rounded border border-vercel-emerald/20 dark:border-vercel-emerald/10 bg-vercel-emerald/10 dark:bg-vercel-emerald/5 flex items-center justify-center text-vercel-emerald"><i data-lucide="graduation-cap" class="w-3.5 h-3.5"></i></div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="bg-vercel-gray-50 dark:bg-vercel-gray-800 border border-vercel-gray-200 dark:border-vercel-gray-700 rounded p-3 text-center group hover:bg-white dark:hover:bg-vercel-gray-900 transition-all">
                                    <div class="text-2xl font-black text-vercel-black dark:text-vercel-white tracking-tighter group-hover:scale-105 transition-transform">${user.bib_count}</div>
                                    <div class="text-[7px] font-black text-vercel-gray-400 uppercase tracking-widest mt-0.5 leading-none">Bibs</div>
                                </div>
                                <div class="bg-vercel-gray-50 dark:bg-vercel-gray-800 border border-vercel-gray-200 dark:border-vercel-gray-700 rounded p-3 text-center group hover:bg-white dark:hover:bg-vercel-gray-900 transition-all">
                                    <div class="text-2xl font-black text-vercel-black dark:text-vercel-white tracking-tighter group-hover:scale-105 transition-transform">${user.project_count}</div>
                        ...
                        <!-- System Timestamps -->
                        <div class="col-span-full pt-4 border-t border-vercel-gray-200 dark:border-vercel-gray-800 grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <div class="text-[9px] text-vercel-gray-400 font-bold uppercase tracking-tight">
                                Registered On <span class="text-vercel-black dark:text-vercel-white font-black whitespace-nowrap">${user.created_at}</span>
                            </div>
                            <div class="text-[9px] text-vercel-gray-400 font-bold uppercase tracking-tight sm:text-right">
                                Latest Login <span class="text-vercel-black dark:text-vercel-white font-black whitespace-nowrap">${user.last_login || 'No Session'}</span>
                            </div>
                        </div>
                     </div>
                </div>
            `,
            footer: `<button class="w-full py-3 bg-vercel-black dark:bg-vercel-white text-white dark:text-vercel-black font-black text-[10px] uppercase tracking-[0.2em] rounded hover:bg-vercel-gray-800 dark:hover:bg-vercel-gray-200 transition-all shadow active:scale-95" onclick="Modal.close(this)">Close Review</button>`
        });
    ...
    async function toggleStatus(id, s) {
        try {
            const res = await API.post('<?php echo SITE_URL; ?>/api/admin/update-user.php', {
                id: id,
                is_active: s
            });
            if (res.success) {
        ...
        Modal.create({
            ...
            onOpen: (m) => {
                m.querySelector('#exec-del').onclick = async () => {
                    ...
                    try {
                        const res = await API.delete('<?php echo SITE_URL; ?>/api/admin/delete-user.php', {
                            id: id
                        });
                        if (res.success) {
