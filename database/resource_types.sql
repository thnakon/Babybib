...
('podcast_series', 'พอดแคสต์ภาพและเสียง (แบบหลายตอน)', 'Podcast Series (Multiple Episodes)', 'media', 'fa-podcast', '{"fields":["host","year_start","year_end","podcast_name","producer","url"]}', 85);
