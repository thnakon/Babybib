...
// 4. Acknowledgment
$templateProcessor->setValue('acknowledgment_content', $coverData['acknowledgment_content'] ?? 'ขอขอบพระคุณอาจารย์ที่ปรึกษาที่ให้คำแนะนำ...');
$templateProcessor->setValue('acknowledgment_signer', $coverData['prefaceSigner'] ?? '[ชื่อผู้จัดทำ]');
$templateProcessor->setValue('acknowledgment_date', $coverData['prefaceDate'] ?? '[วันที่]');

// 5. Thai Abstract
$templateProcessor->setValue('abstract_thai_content', $coverData['abstract_th_content'] ?? 'สรุปสาระสำคัญของงานวิจัย...');
$templateProcessor->setValue('abstract_thai_keywords', $coverData['keywords_th'] ?? 'คำสำคัญ 1, คำสำคัญ 2');

// 6. English Abstract
$templateProcessor->setValue('abstract_english_content', $coverData['abstract_en_content'] ?? 'Summary of the research findings in English...');
...
// 12. Biography
$templateProcessor->setValue('biography_content', $coverData['biography_content'] ?? 'ชื่อ-สกุล ประวัติการศึกษา และผลงาน...');
